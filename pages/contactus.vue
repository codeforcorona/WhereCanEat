<template>
    <div class="flex-col min-w-full items-center justify-center p-5 lg:px-64">
        <div class="bg-teal-500 rounded-lg shadow-lg p-20 space-y-5">
            <h1 class="text-3xl">Sign up for our newsletter!</h1>
        ...
        <span class="p-5"></span>
        <div class="bg-teal-500 rounded-lg shadow-lg p-20 space-y-5 text-2xl text-white font-semibold text-center">
